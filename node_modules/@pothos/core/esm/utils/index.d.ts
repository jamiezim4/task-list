...
import { type InputType, type InputTypeParam, type OutputType, type PartialResolveInfo, type SchemaTypes, type TypeParam } from '../types/index.js';
...
export declare function getMappedArgumentValues(def: GraphQLDirective | GraphQLField<unknown, unknown>, node: DirectiveNode | FieldNode, context: object, info: PartialResolveInfo): Record<string, unknown>;
