...
import type { PrismaConnectionShape, PrismaModelTypes, RelatedConnectionOptions, RelatedFieldOptions, RelationCountOptions, ShapeFromConnection, TypesForRelation, VariantFieldOptions } from './types';
...
export declare class PrismaObjectFieldBuilder<Types extends SchemaTypes, Model extends PrismaModelTypes, Shape extends object = Model['Shape']> extends RootBuilder<Types, Shape, 'PrismaObject'> {
    ...
    exposeBoolean: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], "Boolean", true>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, "Boolean", Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, "Boolean", Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
    ...
    exposeFloat: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], "Float", true>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, "Float", Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, "Float", Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    ...
    exposeID: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], "ID", true>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, "ID", Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, "ID", Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    ...
    exposeString: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], "String", true>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, "String", Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, "String", Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    ...
    exposeBooleanList: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], ["Boolean"], {
        list: true;
        items: true;
    }>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, ["Boolean"], Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, ["Boolean"], Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    }], 0>) => FieldRef<Types, ShapeFromTypeParam<Types, ["Boolean"], Nullable>, "PrismaObject">;
    exposeFloatList: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], ["Float"], {
        list: true;
        items: true;
    }>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, ["Float"], Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, ["Float"], Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    ...
    exposeIntList: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], ["Int"], {
        list: true;
        items: true;
    }>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, ["Int"], Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, ["Int"], Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    }], 0>) => FieldRef<Types, ShapeFromTypeParam<Types, ["Int"], Nullable>, "PrismaObject">;
    exposeIDList: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], ["ID"], {
        list: true;
        items: true;
    }>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, ["ID"], Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, ["ID"], Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    }], 0>) => FieldRef<Types, ShapeFromTypeParam<Types, ["ID"], Nullable>, "PrismaObject">;
    exposeStringList: <Nullable extends boolean, ResolveReturnShape, Name extends CompatibleTypes<Types, Model["Shape"], ["String"], {
        list: true;
        items: true;
    }>>(name: Name, ...args: NormalizeArgs<[options: ExposeNullability<Types, ["String"], Model["Shape"], Name, Nullable> & Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, ["String"], Nullable, {}, ResolveReturnShape>, "description" | "type" | "resolve" | "nullable" | "select"> & {
        description?: string | false;
    ...
    relatedConnection: 'relay' extends PluginName ? <Field extends Model['ListRelations'], Nullable extends boolean, Args extends InputFieldMap, const ConnectionInterfaces extends InterfaceParam<Types>[] = [], const EdgeInterfaces extends InterfaceParam<Types>[] = []>(field: Field, options: RelatedConnectionOptions<Types, Model, Field, Nullable, Args>, ...args: NormalizeArgs<[
        connectionOptions: ObjectRef<Types, ShapeFromConnection<PothosSchemaTypes.ConnectionShapeHelper<Types, TypesForRelation<Types, Model, Field>['Shape'], false>>> | PothosSchemaTypes.ConnectionObjectOptions<Types, ObjectRef<Types, ShapeFromTypeParam<Types, [
