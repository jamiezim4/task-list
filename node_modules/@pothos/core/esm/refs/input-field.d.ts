import { type PothosInputFieldConfig, type PothosTypeConfig, type SchemaTypes, inputFieldShapeKey } from '../types/index.js';
export declare class InputFieldRef<Types extends SchemaTypes, T = unknown> {
    kind: "InputObject";
    fieldName?: string;
    $inferInput: T;
