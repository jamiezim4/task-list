import { type FieldKind, type PothosOutputFieldConfig, type PothosTypeConfig, type SchemaTypes, outputFieldShapeKey } from '../types/index.js';
export declare class FieldRef<Types extends SchemaTypes, T = unknown, Kind extends FieldKind = FieldKind> {
    kind: FieldKind;
    fieldName?: string;
    $inferType: T;
