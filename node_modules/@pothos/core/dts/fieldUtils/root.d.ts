...
import type { FieldKind, FieldNullability, FieldOptionsFromKind, SchemaTypes, TypeParam } from '../types';
...
export declare class RootFieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends BaseFieldUtil<Types, ParentShape, Kind> {
    ...
    ]>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, ["Boolean"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, ["Float"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, ["ID"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, ["Int"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, ["String"], Nullable>, Kind>;
    /**
     * create a new field for the current type
     * @param {PothosSchemaTypes.FieldOptions} options - options for this field
     */
    field<Type extends TypeParam<Types>, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<Type> = Types['DefaultFieldNullability'], Args extends InputFieldMap = {}>(options: FieldOptionsFromKind<Types, ParentShape, Type, Nullable, Args, Kind, ResolveShape, ResolveReturnShape>): import("..").FieldRef<Types, ShapeFromTypeParam<Types, Type, Nullable>, Kind>;
