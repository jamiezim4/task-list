import type { CompatibleTypes, ExposeNullability, FieldKind, FieldNullability, FieldOptionsFromKind, InferredFieldOptionKeys, NormalizeArgs, SchemaTypes, TypeParam } from '../types';
...
export declare class FieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends RootFieldBuilder<Types, ParentShape, Kind> {
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, ["Boolean"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, ["Float"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, ["ID"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, ["Int"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, ["String"], Nullable>, Kind>;
    /**
    ...
    ]>): import("..").FieldRef<Types, import("..").ShapeFromTypeParam<Types, FieldOptionsFromKind<Types, ParentShape, Type, Nullable, {}, Kind, ParentShape, ResolveReturnShape>["type"], (false & (Type extends [unknown] ? Awaited<ParentShape[Name]> extends readonly (infer T)[] | null | undefined ? [T] extends [NonNullable<T>] ? (readonly T[] | null | undefined) & Awaited<ParentShape[Name]> extends readonly T[] & Awaited<ParentShape[Name]> ? boolean | {
        items: boolean;
        list: boolean;
    } : true | {
        items: boolean;
