...
import type { ArgBuilder, InputFieldMap, NormalizeArgs, ShapeFromTypeParam } from '../types/index.js';
import type { FieldKind, FieldNullability, FieldOptionsFromKind, SchemaTypes, TypeParam } from '../types/index.js';
...
export declare class RootFieldBuilder<Types extends SchemaTypes, ParentShape, Kind extends FieldKind = FieldKind> extends BaseFieldUtil<Types, ParentShape, Kind> {
    ...
    ]>): import("../index.js").FieldRef<Types, ShapeFromTypeParam<Types, [
        "Boolean"
    ], Nullable>, Kind>;
    /**
     ...
     * @param {PothosSchemaTypes.FieldOptions} options - options for this field
     */
    field<Type extends TypeParam<Types>, ResolveShape, ResolveReturnShape, Nullable extends FieldNullability<Type> = Types["DefaultFieldNullability"], Args extends InputFieldMap = {}>(options: FieldOptionsFromKind<Types, ParentShape, Type, Nullable, Args, Kind, ResolveShape, ResolveReturnShape>): import("../index.js").FieldRef<Types, ShapeFromTypeParam<Types, Type, Nullable>, Kind>;
